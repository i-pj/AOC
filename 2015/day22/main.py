...
def try_all_games(games, min_mana_spent, part2=False):
    new_games = []
    for game in games:
        if part2:
            game['player_hp'] -= 1
        ...
        min_mana_spent = try_all_spells(game, min_mana_spent, new_games, part2)

    return new_games, min_mana_spent

def try_all_spells(game, min_mana_spent, new_games, part2=False):
...
print("Part 1:", find_minimal_mana(initial_game.copy()))
print("Part 2:", find_minimal_mana(initial_game.copy(), part2=True))
