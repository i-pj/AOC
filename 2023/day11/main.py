...
def calculate_total_distance(expansion_factor):
    ...
    for g1, g2 in itertools.combinations(galaxies, 2):
        ...
        distance = abs(g1[0] - g2[0]) + abs(g1[1] - g2[1]) + (empty_rows_between + empty_cols_between) * (expansion_factor - 1)

        total_distance += distance

    return total_distance

print(calculate_total_distance(2))
print(calculate_total_distance(1000000))
